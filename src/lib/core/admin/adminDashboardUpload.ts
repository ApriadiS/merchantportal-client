import type { PromoObject, StoreObject } from "../types/type";
import {
  saveUploadedData,
  handleUploadExcel as uploadExcelHandler,
} from "../api/UploadHandler";
import type { UploadResult } from "../api/UploadHandler";
import { promos, stores } from "./adminDashboardStore";
import {
  isProcessingUpload,
  isSaving,
  uploadResult,
